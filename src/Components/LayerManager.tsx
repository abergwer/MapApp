...
// Static polygons at fixed geographic locations.
// All coordinates are [lng, lat] as required by Deck.gl.
...
interface LayerManagerProps {
  /** Deck.gl layers to render. Defaults to a sample PolygonLayer. */
  layers?: Layer[];
}
